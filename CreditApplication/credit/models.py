...
class CreditProposal(models.Model):
    ...
    rotation_end = models.DateField()
    name = models.CharField(max_length=200)
    credit_type = models.CharField(max_length=50, choices=CREDIT_TYPE_CHOICES, default='0')
    min_score = models.PositiveIntegerField()
    max_score = models.PositiveIntegerField()
    credit_agency = models.ForeignKey(User, null=True, on_delete=models.SET_NULL, related_name="credit_organization")
...
class CustomerProfile(models.Model):
    ...
    partner = models.ForeignKey(User, null=True, on_delete=models.SET_NULL, related_name='credituser')
...
class CreditApplication(models.Model):
    ...
    owner = models.OneToOneField(User, null=True, on_delete=models.SET_NULL, related_name="owner_application")
